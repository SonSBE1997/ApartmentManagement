INSERT INTO `apartment`.`dept` (`name`) VALUES ('Lễ tân');
...
`phone_number`, `email`, `address`, `id_card`, `username`, `password`, `role`, `dept_id`, `is_manager`) 
    ...
    ('SBE', 1, '1997-1-1', '0898998989', 'sbe@gmailcom', 'Hà Tây', '12345612', 'SBE', '202cb962ac59075b964b07152d234b70', 'Normal', 1, 1),
    ('Son', 1, '1997-1-1', '0987681273', 'son@gmail.com', 'Hà Nội', '123456789', 'son', '202cb962ac59075b964b07152d234b70', 'Manager', 3, 0),
    ('Nguyen Tuan Anh', 1, '1985-1-1', '0987681233', 'tuananh@gmail.com', 'Hà Nội', '123456789', 'tuananh', 									'202cb962ac59075b964b07152d234b70', 'Normal', 2, 0),
    ('Do Xuan Tung', 1, '1987-1-1', '0986121233', 'tung@gmail.com', 'Hà Nội', '123456789', 'tung', 											'202cb962ac59075b964b07152d234b70', 'Normal', 2, 0);
...
INSERT INTO `apartment`.`room` (`name`, `area`, `status`, `floor_id`, `building_id`, `room_type`, `household`) VALUES 
	('201', 70, '0', 1, 1, 'A', 0),
   ('202', 70, '0', 1, 1, 'B', 0),
   ('203', 70, '2', 1, 1, 'A', 2),
   ('204', 70, '2', 1, 1, 'B', 3),
...
INSERT INTO `apartment`.`service_type` (`name`, `price`, `unit`, `supplier`, `is_fixed`) 
VALUES  ('Quản lý chung cư', '80000', 'đồng/m2', 'Ban quản lý chung cư', 1);