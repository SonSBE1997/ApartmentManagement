...
public class MaintenancePersonal implements Serializable {
   ...
   * @param maintenance
   */
  public MaintenancePersonal(int id, boolean isSupervisor, Employee employee) {
    super();
    this.id = id;
